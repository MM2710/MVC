...
$query="UPDATE eleves SET CNE='$cne' and Nom='$nom ' and Prenom='$prenom'
 and Adresse='$adresse' and Ville='$ville' and email='$email' and Photo='$filename' and etat='0' WHERE ID_eleve='$id1'  and CNE='$cne1' ;";
...
<center>
        <form action="" method="post" enctype="multipart/form-data">
            <table>
                <tr><th><h1>Insérer les nouvelles informations de l'étudiant</h1></th></tr><br>
